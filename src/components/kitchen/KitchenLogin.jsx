// src/components/kitchen/KitchenLogin.jsx//
...
const KitchenLogin = ({ isOpen, onClose }) => {
      ...
      >
        <div style={{
          ...
          <div style={{
            ...
            <RestaurantIcon style={{ fontSize: 32, color: 'var(--secondary)' }} />
            <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <AnimatedButton
            ...
            icon={<RestaurantIcon />}
          >
            {loading ? 'Entrando...' : 'Entrar como Cozinha'}
          </AnimatedButton>
          ...
          <div style={{
            ...
            <p style={{
              ...
              <strong>Dica:</strong> Mantenha pressionado o ícone da cozinha por 3 segundos no menu principal para acessar esta tela
            </p>
          </div>
