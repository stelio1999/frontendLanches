// src/components/kitchen/KitchenHeader.jsx
          ...
          >
            <div style={{
              ...
              <p style={{ fontWeight: 600, fontSize: '0.9rem' }}>
                {user?.name || 'Cozinheiro'}
              </p>
              <p style={{ fontSize: '0.75rem', color: glass.textSecondary }}>
                {user?.email || 'kitchen@delivery.com'}
              </p>
            </div>
            ...
            >
              <RestaurantIcon style={{ fontSize: 20, color: glass.textSecondary }} />
              <span>Dashboard</span>
            </button>
            ...
            >
              <InventoryIcon style={{ fontSize: 20, color: glass.textSecondary }} />
              <span>Produtos</span>
            </button>
            ...
            >
              <HistoryIcon style={{ fontSize: 20, color: glass.textSecondary }} />
              <span>Histórico</span>
            </button>
